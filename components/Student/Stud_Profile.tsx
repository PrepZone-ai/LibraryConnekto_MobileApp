...
const Stud_Profile: React.FC = () => {
  ...
  const fetchStudentProfile = async () => {
    try {
      ...
      // Get student profile using FastAPI (includes library info)
      ...
      setProfile({
        ...
        library_name: studentData.library_name || 'Unknown Library',
        subscription_start: studentData.subscription_start ? new Date(studentData.subscription_start).toLocaleDateString() : '',
        subscription_end: studentData.subscription_end ? new Date(studentData.subscription_end).toLocaleDateString() : '',
        shift: studentData.shift_time || 'Regular',
      });
